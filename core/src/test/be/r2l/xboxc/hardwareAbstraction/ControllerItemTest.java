package test.be.r2l.xboxc.hardwareAbstraction;
...
public class ControllerItemTest {
    ...
    public void getButtonForCode_shouldReturnControllerItemForValidButtonCode() {
        ControllerItem item = ControllerItem.getButtonForCode(ControllerItemCodes.BUTTON_A);
    ...
    public void getAxisForCode_shouldReturnControllerItemForValidAxisCode() {
        ControllerItem item = ControllerItem.getAxisForCode(ControllerItemCodes.AXIS_L_STICK_HORIZONTAL_AXIS);
